  ...
  const originalData = [
    {
      ...
      amount: "$34.5",
      status: "Pending",
      badge: ["First Reward", "Consistent Giver", "Star Donor"],
    },
    {
      key: "2",
      name: "M Karim",
      ...
      amount: "$34.5",
      status: "Active",
      badge: ["Momentum Builder", "Consistent Giver"],
    },
    {
      key: "3",
      name: "Josh Adam",
    ...
    },
    {
      ...
      amount: "$34.5",
      status: "Active",
      badge: ["Star Donor", "Momentum Builder", "+5"],
    },
    {
      key: "5",
      name: "Linda Blair",
      ...
      render: (badges) => (
        <div className="flex flex-col gap-1">
          {badges.map((b, i) => (
            <span
              key={i}
              className="px-2 py-1 text-xs rounded-full bg-gray-100 text-gray-600 w-fit"
            >
              {b}
            </span>
          ))}
